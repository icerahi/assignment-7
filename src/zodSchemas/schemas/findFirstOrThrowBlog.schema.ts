...
export const BlogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BlogSelect> = z.object({
...
export const BlogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    content: z.boolean().optional(),
    view: z.boolean().optional(),
...
export const BlogFindFirstOrThrowSchema: z.ZodType<Prisma.BlogFindFirstOrThrowArgs> = z.object({ select: BlogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BlogIncludeObjectSchema.optional()), orderBy: z.union([BlogOrderByWithRelationInputObjectSchema, BlogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BlogWhereInputObjectSchema.optional(), cursor: BlogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BlogScalarFieldEnumSchema, BlogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BlogFindFirstOrThrowArgs>;

export const BlogFindFirstOrThrowZodSchema = z.object({ select: BlogFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BlogIncludeObjectSchema.optional()), orderBy: z.union([BlogOrderByWithRelationInputObjectSchema, BlogOrderByWithRelationInputObjectSchema.array()]).optional(), where: BlogWhereInputObjectSchema.optional(), cursor: BlogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BlogScalarFieldEnumSchema, BlogScalarFieldEnumSchema.array()]).optional() }).strict();