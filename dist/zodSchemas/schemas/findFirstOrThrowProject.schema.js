...
exports.ProjectFindFirstOrThrowZodSchema = exports.ProjectFindFirstOrThrowSchema = exports.ProjectFindFirstOrThrowSelectZodSchema = exports.ProjectFindFirstOrThrowSelectSchema = void 0;
...
//------------------------------------------------------
exports.ProjectFindFirstOrThrowSelectSchema = z.object({
...
exports.ProjectFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    thumbnail: z.boolean().optional(),
    projectLink: z.boolean().optional(),
...
exports.ProjectFindFirstOrThrowSchema = z.object({ select: exports.ProjectFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProjectInclude_schema_1.ProjectIncludeObjectSchema.optional()), orderBy: z.union([ProjectOrderByWithRelationInput_schema_1.ProjectOrderByWithRelationInputObjectSchema, ProjectOrderByWithRelationInput_schema_1.ProjectOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectWhereInput_schema_1.ProjectWhereInputObjectSchema.optional(), cursor: ProjectWhereUniqueInput_schema_1.ProjectWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectScalarFieldEnum_schema_1.ProjectScalarFieldEnumSchema, ProjectScalarFieldEnum_schema_1.ProjectScalarFieldEnumSchema.array()]).optional() }).strict();
exports.ProjectFindFirstOrThrowZodSchema = z.object({ select: exports.ProjectFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProjectInclude_schema_1.ProjectIncludeObjectSchema.optional()), orderBy: z.union([ProjectOrderByWithRelationInput_schema_1.ProjectOrderByWithRelationInputObjectSchema, ProjectOrderByWithRelationInput_schema_1.ProjectOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProjectWhereInput_schema_1.ProjectWhereInputObjectSchema.optional(), cursor: ProjectWhereUniqueInput_schema_1.ProjectWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProjectScalarFieldEnum_schema_1.ProjectScalarFieldEnumSchema, ProjectScalarFieldEnum_schema_1.ProjectScalarFieldEnumSchema.array()]).optional() }).strict();
